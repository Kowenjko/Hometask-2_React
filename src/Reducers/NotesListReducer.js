...
const initialState = {
  ...
  ListArchive: [],
  notesTotal: [
    { id: uuidv4(), category: "Task", active: 1, archive: 0 },
    { id: uuidv4(), category: "Quote", active: 2, archive: 0 },
    { id: uuidv4(), category: "Random Thought", active: 2, archive: 0 },
    { id: uuidv4(), category: "Idea", active: 2, archive: 0 },
  ],
  editCreate: false,
  archiveView: false,
  CurrentNotes: null,
